...
public class BookingServiceImpl implements BookingService {
    ...
    public Booking getBookingById(Long bookingId) {
        ...
        return bookingRepository.findById(bookingId)
                .orElseThrow(() -> {
                    ...
                    return new BookingNotFoundException("Enter a valid Booking Id.");
                });
    }
    ...
    public Booking bookRoom(Long hotelId) {
        ...
        User user = userRepository.findByEmail(userName)
                .orElseThrow(() -> {
                    ...
                    return new UserNotFoundException("Please register to book a room.");
                });
    ...
    public void cancelBooking(Long bookingId) {
        ...
        Booking booking = bookingRepository.findById(bookingId)
                .orElseThrow(() -> {
                    logger.error("Booking with ID '{}' not found", bookingId);
                    return new RuntimeException("Booking not found, Provide a valid booking Id");
                });
